//https://teachablemachine.withgoogle.com/models/sOZ1WmvC1/

function startClassification(){
    navigator.mediaDevices.getUserMedia({audio:true})
    classifier=ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/sOZ1WmvC1/.model.json", modelready)
}
function modelready(){
